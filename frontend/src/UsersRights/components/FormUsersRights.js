...
import FeaturesTab from './formComponents/FeaturesTab';
import ClientsTab from './formComponents/ClientsTab';
    ...
    return (
        <div style={{ width: 800 }}>
            <CustomTextField
                ...
                handleChange={e => this.props.handleChangeForm({ ...this.props.editedSetting, email: e.target.value })}
                type='text'
                width={'50%'}
                isRequired={true}
          >
        ...
        >
          ...
          />
                <ClientsTab
                    ...
                    clientsRightIdMapping={this.props.clientsRightIdMapping}
          />
            </SwipeableViews>
        </div>
    );
...
FormUsersRights.propTypes = {
  ...
  editedSetting: PropTypes.shape({
    ...
    authorized_clients: PropTypes.array.isRequired
  }),
  ...
  importsList: PropTypes.array.isRequired,
